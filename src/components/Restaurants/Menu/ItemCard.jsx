    ...
    return(
        ...
        <div className="w-full flex justify-between mb-2 pb-2">
            ...
            <div className="w-[25%] relative">
                ...
                {
                    count===0 ? (<button className="absolute bottom-2 left-16 rounded-xl text-xl font-bold text-green-500 w-28 h-12 shadow-md border border-white  bg-white" onClick={()=>handleAddItems()}>ADD</button>) :
                            (
                                <div className="flex justify-center items-center gap-3 w-28 h-12 absolute bottom-2 left-16 rounded-xl font-bold text-xl text-green-500 shadow-md border border-white  bg-white">
