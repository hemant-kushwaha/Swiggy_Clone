    ...
    return(
        ...
        <div className="w-full flex justify-between mb-2 pb-2">
            ...
            <div className="w-[25%] relative">
                ...
                {
                    count===0 ? (<button className="absolute bottom-2 left-16 rounded-xl text-xl font-bold text-green-500 px-8 py-2 shadow-md border border-white  bg-white" onClick={()=>handleAddItems()}>ADD</button>) :
                            (
                                <div className="flex gap-2 absolute bottom-2 left-16 rounded-xl font-bold text-xl text-green-500 px-8 py-2 shadow-md border border-white  bg-white">
