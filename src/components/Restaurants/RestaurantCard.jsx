...
export default  function RestaurantCard ({restInfo}) {
    return(
        ...
        <div className="w-68  h-[300px] overflow-hidden mb-2 transition-all duration-300 hover:scale-[95%] hover:shadow-lg">
         ...
         <div className="w-[95%] mx-auto mt-4">
           <h2 className="font-bold text-xl overflow-hidden whitespace-nowrap text-ellipsis ">{ restInfo?.info?.name}</h2>
